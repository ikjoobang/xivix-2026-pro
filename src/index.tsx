...
const TITLE_PATTERNS = [
  "{keyword}, 지금 가입해도 될까요?",
  "{target} {keyword} 비교, 어떻게 해야 할까?",
  "{keyword} 보장 범위, 꼭 확인하세요",
  "{target}를 위한 {keyword} 선택 가이드",
  "{keyword}, 나에게 맞는 상품은?"
]
...
🚨 [제목 5개 생성 규칙]
- 공백 포함 25자 이내 필수
- 자극적/어그로 단어 절대 금지: "충격", "손해", "필독", "경악", "대박", "100%", "절대" 등
- 차분하고 신뢰감 있는 정보성 제목으로 작성
- 예시: "암보험, 지금 준비해도 될까요?", "30대 실손보험 비교 가이드"

🚨 [바이럴 질문 2개 생성 규칙]
- 800자 이내
- 보험을 전혀 모르는 초보자가 간절하게 질문하는 형태
- "이거 모르면 손해" 같은 전문가 어투 절대 금지
- 구체적인 개인 상황 + 진심으로 도움을 구하는 간절한 말투
- 예시: "보험을 처음 알아보는데 뭐부터 해야 할지 모르겠어요. 도와주세요..."

JSON 형식으로만 응답:
{ "titles": [{"id":1,"text":"25자 이내 제목"},...], "viral_questions": [{"id":1,"text":"초보자 관점의 간절한 질문"},...] }`
